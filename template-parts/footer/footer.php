<footer id="colophon" class="site-footer">
	...
	<div class="footer-credits">
      ...
      <a href="<?php echo esc_url( __( 'https://wordpress.org/',  'modul-r' ) ); ?>"><?php __('Proudly powered by WordPress',  'modul-r'); ?></a> -
      ...
      <a href="<?php echo esc_url( __( 'https://codekraft.it',  'modul-r' ) ); ?>"><?php __('Made with &hearts; by codekraft-studio.',  'modul-r'); ?></a>
		</p>
	</div>
