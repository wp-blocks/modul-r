<footer id="colophon" class="site-footer">
	...
	<div class="footer-credits">
      ...
      <a href="<?php esc_url( __( '//wordpress.org/', 'modul-r' )); ?>"><?php _e('Proudly powered by WordPress',  'modul-r'); ?></a> -
      ...
      <a href="<?php echo esc_url( __('//codekraft.it', 'modul-r') ); ?>"><?php _e('Made with &hearts; by codekraft-studio.',  'modul-r'); ?></a>
		</p>
	</div>
