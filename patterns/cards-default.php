 ...
 * Slug: modul-r/cards-default
 * Categories: text, modul-r
 */
?>
<!-- wp:columns {"align":"wide","className":"block-overlap-top card-columns interactive animated"} -->
<div class="wp-block-columns alignwide block-overlap-top card-columns interactive animated"><!-- wp:column -->
	<div class="wp-block-column"><!-- wp:image {"align":"center","id":1234,"width":-100,"height":100,"sizeSlug":"full","linkDestination":"custom"} -->
		<div class="wp-block-image">
			<figure class="aligncenter size-full is-resized"><img src="'. esc_url(get_template_directory_uri()) . '/img/wapuu-original.png" class="wp-image-1234" width="85" height="93"/></figure>
	...
	<div class="wp-block-column"><!-- wp:image {"align":"center","id":1234,"width":85,"height":93,"sizeSlug":"full","linkDestination":"custom"} -->
		<div class="wp-block-image">
			<figure class="aligncenter size-full is-resized"><img src="'. esc_url(get_template_directory_uri()) . '/img/wapuu-original.png" class="wp-image-1234" width="85" height="93"/></figure>
