...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-comments">
		<!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"0","top":"var:preset|spacing|70"},"padding":{"top":"0","bottom":"0"}}}} -->
		...
		<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-column"><!-- wp:comment-author-name /-->
				...
				<div class="wp-block-group" style="margin-top:0px;margin-bottom:0px"><!-- wp:comment-date {"style":{"elements":{"link":{"color":{"text":"var:preset|color|gray"}}},"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"small"} /-->
					...
					<!-- wp:comment-edit-link {"style":{"elements":{"link":{"color":{"text":"var:preset|color|gray"}}},"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"small"} /-->
				</div>
				<!-- /wp:group -->
		...
		<!-- wp:post-comments-form {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|70"}}},"fontSize":"default"} /-->
	</div>
	<!-- /wp:comments -->
</div>
<!-- /wp:group -->
