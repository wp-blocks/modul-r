...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-query alignwide modulr-grid"><!-- wp:post-template {"align":"wide","layout":{"type":"grid","columnCount":3}} -->
		<!-- wp:group {"align":"wide","style":{"border":{"width":"1px","color":"#f3f3f3","radius":"3px"},"spacing":{"blockGap":"0"}},"className":"is-style-card","layout":{"type":"default"}} -->
		<div class="wp-block-group alignwide is-style-card has-border-color" style="border-color:#f3f3f3;border-width:1px;border-radius:3px"><!-- wp:post-featured-image {"isLink":true,"width":"100%","height":"260px","align":"center","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} /-->
