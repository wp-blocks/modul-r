...
if ( ! function_exists( 'modul_r_theme_setup' ) ) :
	...
	function modul_r_theme_setup() {
		...
		*/
		...
		/** Adding support for a custom header. */
		add_theme_support(
			'custom-header',
			array(
				'default-image'          => '',
		...
		/** Adding support for the custom background feature. */
		add_theme_support(
			'custom-background',
			array(
		...
		/** Spacing control some blocks can have padding controls. Some blocks like paragraph and headings support customizing the line height */
...
/**
 * If the user is on the themes page, display a notice
 *
 * @param string $message - The message you want to display.
 * @param string $link - The URL to the page you want to link to.
 */
function modul_r_activation_notice( $message = false, $link = false ) {

	$message = $message ? $message : 'Thank you for choosing Modul-R. Please take a look at the quick start guide to find out how to get the most out of this template!';
	$link    = $link ? $link : 'https://modul-r.codekraft.it/theme-setup/';

	global $pagenow;
	if ( is_admin() && ( 'themes.php' === $pagenow ) ) {
		echo '<div class="notice notice-success is-dismissible welcome-notice ">';
		printf( '<p>%s</p><p><a href="%s" class="button button-primary" target="_blank" >%s</a></p>', esc_html( $message ), esc_url( $link ), esc_html__( 'Getting started', 'modul-r' ) );
		echo '</div>';
	}
}
